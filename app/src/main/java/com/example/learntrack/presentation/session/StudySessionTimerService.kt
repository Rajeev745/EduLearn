...
import com.example.learntrack.utils.StudyConstants.NotificationConstants.NOTIFICATION_ID
...
import com.example.learntrack.utils.toPad
...
@AndroidEntryPoint
class StudySessionTimerService @Inject constructor() : Service() {
            ...
            when (serviceAction) {
                ACTION_SERVICE_START -> {
                    ...
                    startTimer { hours, minutes, seconds ->
                        updateNotifications(hours, minutes, seconds)
                    }
                }
    ...
    private fun updateTimeUnits() {
        duration.toComponents { hours, minutes, seconds, _ ->
            this@StudySessionTimerService.hours.value = hours.toInt().toPad()
            this@StudySessionTimerService.minutes.value = minutes.toPad()
            this@StudySessionTimerService.seconds.value = seconds.toPad()
        }
    }
